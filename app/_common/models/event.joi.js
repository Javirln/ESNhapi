...
const BaseSchema = Joi.object({
    ...
    code: Joi.string().regex(/^[A-Z]{2}-[A-Z]{2,4}-[A-Z0-9]{3,4}-events-[0-9]+$/)
        .example('AA-AAAA-AAA-events-1234')
    ...
    dateEnds: Joi.date().optional()
        .example('2016-06-10T12:00:00+02:00')
    ...
    meetingPoint: Joi.any().optional()
        .example('Midtown')
        .description('Where is the meeting point'),

    moreInformation: Joi.array().optional()
        .items(
            Joi.string()
    ...
    location: Joi.any()
        .example('POINT (-0.1214235 40.6650743)'),

...
const BaseSchema = Joi.object({
    code: Joi.string().regex(/^[A-Z]{2}-[A-Z]{2,4}-[A-Z0-9]{3,4}-partners-[0-9]+$/).example('AA-AAAA-AAA-partners-1234')
        .description('Code of the new'),
    name: Joi.string().example('Awesome partner name')
    ...
    .label('Partner')
    .requiredKeys('code', 'name', 'content', 'country', 'city', 'section', 'lastUpdate');
